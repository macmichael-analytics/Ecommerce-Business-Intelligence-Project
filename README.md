...
## Project Execution
I'm going to use MYSQL to analyse landing page performance and conversion, as well as product-level sales. The SQL solution codes have been attacked to this repository as [sql_query_solution.sql](https://github.com/macmichael-analytics/Ecommerce_Business_Intelligence_project/blob/main/sql_query_solution.sql) .
